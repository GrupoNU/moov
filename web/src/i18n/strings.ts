...
export const en = {
  ...
  "settings.identity.nameLabel": "Sender name",
  "settings.identity.nameHelp": "How your name appears on the mail you send",
  "settings.identity.namePlaceholder": "Your name",
  "settings.identity.nameFailed": "The sender name could not be saved",
...
export const es: Strings = {
  ...
  "settings.identity.nameLabel": "Nombre del remitente",
  "settings.identity.nameHelp": "Así aparece tu nombre en los correos que enviás",
  "settings.identity.namePlaceholder": "Tu nombre",
  "settings.identity.nameFailed": "El nombre del remitente no se pudo guardar",
